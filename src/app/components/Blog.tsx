...
const articles: Article[] = [
  {
    ...
    readTime: "5 min",
    thumbnail:
      "https://images.unsplash.com/photo-1764106813759-9ef7bf42a0af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGxlZ2FsJTIwZG9jdW1lbnRzJTIwY29udHJhY3R8ZW58MXx8fHwxNzcxNzYxODk5fDA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt:
      "Understanding the latest fiscal changes and compliance requirements for Tunisian companies.",
  },
  {
    id: 2,
    ...
    readTime: "7 min",
    thumbnail:
      "https://images.unsplash.com/photo-1601387913800-b48217dc5fa2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwdGVjaG5vbG9neSUyMHN0YXJ0dXAlMjBvZmZpY2V8ZW58MXx8fHwxNzcxNzYxODk5fDA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt:
      "Exploring cutting-edge technologies and strategies for modern web solutions.",
  },
  {
    id: 3,
    title:
      "Corporate Structuring: Choosing the Right Business Entity in Tunisia",
    category: "Legal/Fiscal",
    readTime: "6 min",
    thumbnail:
      "https://images.unsplash.com/photo-1762151662378-f40e20901824?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0YXglMjBhY2NvdW50aW5nJTIwZmluYW5jaWFsJTIwY29uc3VsdGluZ3xlbnwxfHx8fDE3NzE3NjE4OTl8MA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt:
      "A comprehensive guide to selecting the optimal legal structure for your venture.",
  },
  {
    id: 4,
    ...
    readTime: "8 min",
    thumbnail:
      "https://images.unsplash.com/photo-1540397106260-e24a507a08ea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWIlMjBkZXZlbG9wbWVudCUyMGNvZGluZyUyMGxhcHRvcHxlbnwxfHx8fDE3NzE3NDI3MTh8MA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt:
      "Best practices for creating scalable and efficient digital solutions.",
  },
  {
    id: 5,
    ...
    readTime: "5 min",
    thumbnail:
      "https://images.unsplash.com/photo-1758518731462-d091b0b4ed0d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3Jwb3JhdGUlMjBsYXclMjBvZmZpY2UlMjBwcm9mZXNzaW9uYWx8ZW58MXx8fHwxNzcxNzYxOTAwfDA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt:
      "Essential regulatory considerations for international business expansion.",
  },
  {
    id: 6,
    ...
    readTime: "6 min",
    thumbnail:
      "https://images.unsplash.com/photo-1562577309-4932fdd64cd1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwbWFya2V0aW5nJTIwc29jaWFsJTIwbWVkaWF8ZW58MXx8fHwxNzcxNjk0MDIzfDA&ixlib=rb-4.1.0&q=80&w=1080",
    excerpt:
      "Maximizing your corporate visibility through strategic digital marketing.",
  },
];
        ...
        <nav className="container mx-auto px-4 sm:px-6 py-4 md:py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link to="/blog" className="text-cyan-400 font-semibold">
                Blog
              </Link>
              <a
                href="#contact"
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex gap-2">
              {(["All", "Legal/Fiscal", "Digital/Tech"] as Category[]).map(
                (category) => (
                  <button
                    key={category}
            ...
            <aside className="lg:w-80 space-y-8">
              ...
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-xl p-8">
                ...
                <p className="text-gray-300 text-sm mb-6">
                  Get exclusive B2B insights, industry trends, and expert advice
